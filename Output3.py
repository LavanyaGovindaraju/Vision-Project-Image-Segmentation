...
acc,f1,jacc,sens= evaluation_metrics(lab[0],pred_out.argmax(1)[0])

print("accuracy: {}, sensitivity: {}, f1-score: {}, jaccard-score: {}".format(acc,f1,jacc,sens))
# Akash Kumar akku00001@teams.uni-saarland.de 7009735
# Harisree Kallakuri haka00001@teams.uni-saaland.de 7009317
...
model= AttU_Net(img_ch=3,output_ch=34,t=2)
model.load_state_dict(torch.load('epochs-4.pt'))
model.eval()
model.cuda()
